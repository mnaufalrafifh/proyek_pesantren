            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">List Kategori Kegiatan</h4>
                                @if (session('status'))
                            ...
                            <div class="mb-4 ml-2">
                                <a href="{{ route('kategori-kegiatan.create') }}" class="btn btn-primary">Tambah Data</a>
                            </div>
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <div class="p-2">
                                                    <a href="{{ route('kategori-kegiatan.edit', $item->id) }}" class="btn btn-warning">Ubah</a>
                                                </div>
                                                 <div class="p-2">
