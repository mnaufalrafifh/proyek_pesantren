            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Edit Kategori Kegiatan</h4>
                    </div>
                    @if (session('error'))
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="comment-widgets" style="height:430px;">
                              <form action="{{ route('kategori-kegiatan.update', $data->id) }}" method="POST" autocomplete="off">
                                @method('PUT')
                                @csrf
                                <div class="form-group">
                                    <label for="" class="ml-4">Nama Kategori</label>
                                    <div class="col-sm-10 ml-3">
                                      <input type="text" name="nama_kategori" value="{{ old('nama_kategori', $data->nama_kategori) }}" class="form-control" @error('nama_kategori') is-invalid @enderror" id="">
                                    </div>
                                    @error('nama_kategori')
