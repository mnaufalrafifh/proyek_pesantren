            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Tambah Data Tenaga Kerja</h4>
                            </div>
                            <div class="comment-widgets" style="height:580px;">
                              <form action="{{ route('tenaga-kerja.store') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="" class="ml-4">Nama Depan</label>
                                    <div class="col-sm-10 ml-3">
                                      <input type="text" name="nama_depan" class="form-control " @error('nama_depan') is-invalid @enderror id="">
                                    </div>
                                    @error('nama_depan')
                                    ...
                                    <div class="col-sm-10 ml-3">
                                      <input type="text" name="nama_belakang" class="form-control " @error('nama_belakang') is-invalid @enderror id="">
                                    </div>
                                    @error('nama_belakang')
                                        <small class="text-danger ml-4" for="">{{ $message }}</small>
                                    @enderror
                                    ...
                                    <div class="col-sm-10 ml-3">
                                      <textarea name="alamat" class="form-control " @error('alamat') is-invalid @enderror id=""></textarea>
                                    </div>
                                    @error('alamat')
                                    <small class="text-danger ml-4" for="">{{ $message }}</small>
                                    @enderror
                                    ...
                                    @enderror
                                    <br>
                                    <label for="" class="ml-4 mt-2">Upload Foto</label>
                                    <div class="col-sm-10 ml-3">
