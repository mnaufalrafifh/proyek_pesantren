...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('') }}back-end/assets/images/LOGO.png">
    <title>Admin</title>
    <!-- Custom CSS -->
...
<body>
    ...
    <script src="{{ asset('') }}back-end/assets/libs/popper.js/dist/umd/popper.min.js"></script>
    <script src="{{ asset('') }}back-end/assets/libs/bootstrap/dist/js/bootstrap.min.js"></script>
